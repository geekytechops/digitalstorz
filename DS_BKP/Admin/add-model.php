...
<body>
	...
	<div class="main_container">
		...
		<div class="right_container">
			<div class="page_title_div"><h1>ADD PRODUCT MODEL</h1></div>
			<div class="content_holder">

				<div class="content_holder_heading">&#8803;&nbsp;&nbsp;Add / Update Product Company &nbsp;&nbsp;&nbsp;<?php echo $mess;?></div>
				
				<div class="content_holder_body">
				<form name="model_add" method="post" action="./add-model.php" onsubmit="return validate()">
					...
					<div><input type="text" name="model_no" value="<?php echo $upd_model_no;?>" ></div>
					<div class="txt_lable">Model Name:</div>
					<div><input type="text" name="model_name" value="<?php echo $upd_model_name;?>" ></div>
											...
											<?php
												...
												//print_r($result_get_company_name);
													echo '<tr>
															...
															<td><a href="./add-model.php?mode=edit&mod_id='.$result_com['mod_id'].'"><img style="border:none; width:15px; height:15px;" src="./img/edit-icon.jpg"/></a></td>
															<td><a href="./add-model.php?mode=del&mod_id='.$result_com['mod_id'].'"><img style="border:none; width:15px; height:15px;"src="./img/delete-icon.jpg"/></a></td>
													</tr>';
												}
											?>
												</table>
