...
//echo '-----------------'.$user_accounts_for_store;
	...
	$sql_ins="INSERT INTO `cust_kolors_users_list`(`user_role`,`store_id`,`store_name`,`admin_id`, `username`, `password`, `staff_name`, `staff_dob`, `staff_mobile`, `staff_email`, `staff_residence`, `status`, `add_date`) VALUES 
	('".$user_role."','".$store_id."','".$store_name."','".$admin_id."','".$store_user_name."','".$hashed_password."','".$staff_name."','".$staff_dob."','".$staff_mobile."','".$staff_email."','".$staff_residence."',1,NOW())";
   //echo $sql_ins;exit;
				...
				<div class="content_holder_body">
					...
					<table style="margin-left:30px">
					 ...
					 <?php
					    ...
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Enter User ID (Mobile Number)&nbsp;&nbsp;</td> <td><input type="text"  name="store_user_name" id="store_user_name" value="<?php echo $result_get_details['username'];?>" maxlength=10 onkeypress="return numbersonly1(event)" /></td><td style="color:red; font-size:17px;padding-left:15px;">&#x2731;</td></tr>
					     <?php
					        }
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Name&nbsp;&nbsp;</td> <td><input type="text" name="staff_name" value="<?php echo $result_get_details['staff_name'];?>"></td><td style="color:red; font-size:17px;padding-left:15px;">&#x2731;</td></tr>
			
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Enter password&nbsp;&nbsp;</td> <td><input type="password" name="store_passwd"  id="store_passwd"value=""></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td><td><input type="checkbox" onclick="ShowPassword()">Show Password</td></tr>
					    <?php
					        if($_REQUEST['mode']!='edit'){
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Re-Enter Password&nbsp;&nbsp;</td> <td><input type="password" name="store_reenter_passwd" id="store_reenter_passwd" value="" ></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td><td><input type="checkbox" onclick="ShowPassword2()">Show Password</td></tr>
			            <?php
					        }
					    ?>
					    ...
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Mobile Number&nbsp;&nbsp;</td> <td><input type="text" name="staff_mobile" value="<?php echo $result_get_details['staff_mobile'];?>" maxlength=10 onkeypress="return numbersonly(event)"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Email Address&nbsp;&nbsp;</td> <td><input type="text" name="staff_email" value="<?php echo $result_get_details['staff_email'];?>"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
