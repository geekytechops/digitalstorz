...
if(isset($_REQUEST['mode']) && $_REQUEST['mode']=='edit'){
    ...
    $note="Please Note That the details you are updating will be displayed to customer in Invoice.";
}
			...
			<div class="content_holder">
				...
				<div class="content_holder_body">
					...
					<table style="margin-left:30px">
					    ...
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Store Name&nbsp;&nbsp;</td> <td><input type="text" name="store_name" value="<?php echo $result_get_details['store_name'];?>"></td><td style="color:red; font-size:17px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Store Contact Number&nbsp;&nbsp;</td> <td><input type="text" name="store_contact" value="<?php echo $result_get_details['store_contact'];?>" maxlength=10 onkeypress="return onlyNumberKey(event)"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Store Address Line 1&nbsp;&nbsp;</td> <td><input type="text" name="store_address1" value="<?php echo $result_get_details['store_address1'];?>"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Store Address Line 2&nbsp;&nbsp;</td> <td><input type="text" name="store_address2" value="<?php echo $result_get_details['store_address2'];?>"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td>&nbsp;</td></td></tr>
