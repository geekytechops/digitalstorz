...
<body>
	...
	<div class="main_container">
		...
		<div class="right_container">
			<div class="page_title_div"><h1>CUSTOMER JOB DELIVERY</h1></div>
			<div class="content_holder">
				...
				?>
					...
					<table>
						...
						<tr>
							<td><input  type="text" id="actual_amount" onblur="cal_bal()" name="actual_amount" value="<?php echo $est_amount ?>" onpaste="return false;" ondrop="return false;" autocomplete="off" onkeypress="return onlyNumberKey(event)"></td>
						...
						?>
							...
							<td><input type="text" name="spare_cost" onpaste="return false;" ondrop="return false;" autocomplete="off" value="<?php echo $sparecost;?>" onkeypress="return isNumberKey(event)" ></td>
