		...
		<div class="right_container_index">
			...
			<div class="content_holder_small">
				...
				<form name="retail_login" onpaste="return false;" ondrop="return false;" autocomplete="off" method="post" action="./user-registration.php" onsubmit="return validate()">
					...
					<div><input type="number"  id="username_retail" name="username_retail" placeholder="Only Numbers Allowed" value=""  required pattern="[0-9]{10}" onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return (event.keyCode == 69 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 187) ? false : true" onblur="CheckUserName();"/>&#x2731;&nbsp;<span id="ErrorSpan" style=" color:blue; font-weight:bold; font-size:12px;"></span></div>
					...
					<div><input class="text_box" type="number" placeholder="Only Numbers Allowed" name="retail_store_contact" value="" required pattern="[0-9]{10}" onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return (event.keyCode == 69 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 187) ? false : true">&nbsp;&#x2731;&nbsp;<span style="color:#000">(This will be Shown to Customer)</span></div>
					...
					<div><input class="text_box" type="number" name="referal_code" maxlength="10" required pattern="[0-9]{10}" onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return (event.keyCode == 69 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 187) ? false : true" value=""  ></div>
