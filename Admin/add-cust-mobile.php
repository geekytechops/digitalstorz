...
if(isset($_REQUEST['submit'])){ //When form Submits
		...
		('".$cust_name."','".$mobile_name."','".$contact_no."','".$alt_contact_no."','".$send_sms_alt_cont."','".$imei_sn."','".$mobile_defect."','".$mobile_defect2."','".$mobile_defect3."','".$mobile_defect4."','".$exp_delivery."','".$est_amount."','".$adv_amount."','".$remarks."','".$cur_time ."','Pending', '0','0','".$added_by."','".$store_id."','".$adv_payment_mode."','".$gst_transaction."','".$cust_gst_no."')";
		//echo $sql_ins; exit;
			...
			<div class="content_holder">
				...
				<form name="category_add" method="post" action="./add-cust-mobile.php" onsubmit="return validate()">
					<table>
						...
						<td><input type="number" maxlength="10" name="contact_no" value="<?php echo $cust_contact ?>" onchange="getData(this.value, 'customer_name')"   ondrop="return false;" autocomplete="off" required required pattern="[0-9]{10}" onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return (event.keyCode == 69 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 187) ? false : true" >&nbsp;&nbsp;</td>
						<td><input type="text" id="customer_name" name="customer_name" value="<?php echo $customer_name ?>" >&nbsp;&nbsp;</td>
						<td><input type="number" maxlength="10" name="alt_contact_no" value="<?php echo $cust_alt_contact ?>"   onpaste="return false;" ondrop="return false;" autocomplete="off" pattern="[0-9]{10}" onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return (event.keyCode == 69 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 187) ? false : true" >&nbsp;&nbsp;</td>
						<?php
						    if($send_sms_to_alt=="sendalt"){
						?>
						...
						<tr>
							...
							<td><input  type="number" name="est_amount" value="<?php echo $est_amount ?>" onkeypress="return onlyNumberKey(event)" onkeydown="return event.keyCode !== 69" onpaste="return false;" ondrop="return false;" autocomplete="off"></td>
						...
						<tr>
							<td class="txt_lable">Defect 1: <b style="color:red">&#10035;</b></td> 
						   	...
						   	<!---<td class="txt_lable">GST (Optional)</td>-->
						</tr>
					...
					?>
						...
						<tr>
							...
							<!--<td class="txt_lable">Customer GST Number (Optional):</td>-->
						</tr>
						<tr>
					...
					?>
							...
							<!--<td><input type="text" name="customer_gst_no" value="<?php echo $cust_gst_no;?>"> </td>-->
						</tr>
					...
					?>
						...
						<tr>
						   ...
						   <td>
							...
							<td><input  type="text" id="date_picker" name="exp_delivery" value="<?php echo $exp_delivery ?>" ></td>
