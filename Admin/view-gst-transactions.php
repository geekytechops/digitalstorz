...
<head>
	...
	<div class="main_container">
		...
		<div class="page_title_div"><h1>VIEW GST TRANSACTIONS</h1></div>
			<div class="content_holder">    

<form name="view_transactions" method="post" action="./view-gst-transactions.php" onsubmit="return validate()">
