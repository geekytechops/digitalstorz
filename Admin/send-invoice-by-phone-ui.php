        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">GENERATE INVOICE BY CUSTOMER PHONE NO</h4>
                            ...
                            <div class="col-xl-12 col-sm-6">
                                    <div class="card">
                                        ...
                                        <form name="send_invoice" method="post" action="./send-invoice-by-phone.php" onsubmit="return validate()">
                                            ...
                                            <div class="mb-2">  <input type="text" name="cust_phone_no" class="form-control" value="<?php echo $cust_phone_no;?>" onkeypress="return onlyNumberKey(event)" maxlength=10></div>
                    ...
                    <tr style="background:#8D8D8E"><th>Job ID</th><th>Customer Name</th><th>Device Name</th><th>Defect</th><th>Amount</th><th>Select</th></tr>
                <?php
                ...
                ?>
                <tr><td colspan=6 style="text-align:right"><input type="submit" class="btn btn-primary" name="submit_selected" value="Submit Selected" ></td></tr>                
                <?php
