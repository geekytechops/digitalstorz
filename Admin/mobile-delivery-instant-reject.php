...
<body>
	...
	<div class="main_container">
		...
		<div class="right_container">
			<div class="page_title_div"><h1>REJECTED JOB DELIVERY</h1></div>
			<div class="content_holder">

				<div class="content_holder_heading">&#8803;&nbsp;&nbsp;Rejected Delivery &nbsp;&nbsp;&nbsp;<?php echo $mess;?></div>
				...
				?>
					...
					<table>
						...
						<tr>
							...
							<td><input  type="text" readonly=yes name="est_amount" value="<?php echo $est_amount ?>" ></td>
						...
						<tr>
							<td><input  type="text" id="actual_amount" onblur="cal_bal()" name="actual_amount" readonly=yes value="<?php echo $actual_amount ?>" onkeypress="return numbersonly2(event)"></td>
						...
						<tr>
							...
							<td><input  type="text" id="bal_amt" name="bal_amt" disabled=yes value="<?php echo $balance_amt;?>" onkeypress="return numbersonly3(event)"></td>
							<td><input  type="text" id="inst_rej_reason" name="inst_rej_reason" value="<?php echo $inst_rej_reason;?>" ></td>
						...
						?>
							...
							<td><input type="number" name="spare_cost" value="<?php echo $sparecost;?>" onkeypress="return isNumberKey(event)" onpaste="return false;" ondrop="return false;" autocomplete="off" ></td>
