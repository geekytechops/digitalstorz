...
if(isset($_REQUEST['delivery-id'])){ 
	...
	$inst_rej_reason=$result_disp['rejected_reason'];
...
if(isset($_REQUEST['submit'])){ 
	...
	$cur_time = date('Y-m-d H:i:s');
		...
		if($send_invoice_cust=='send_receipt'){
			...
			$message='Dear '.$customer_name_msg.', your Device '.$mobile_name_msg.', handed over to you. Thank you and visit again. '.$session_store_name.'. - DigitalStorz';
    ...
    if($session_user_subscription_plan == 'trail' || $session_user_subscription_plan == 'trail-mobialive'){ //if pack is trail
		if($result_sentmessages_count['message_sent_count'] < 200){ //if pack is trail and sms is less than 200
		...
		}else{ //if pack is trail and sms is greater than 200
		    header('Location: view-cust-mobile-entry.php?result_key=pend&dmsg=mds');  
		}
    }else{ //if pack is not trail 
        //updating message count in stores.
		$message_length=strlen($message);
        $no_of_messages=ceil($message_length/160);
        //echo $no_of_messages;
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">REJECTED JOB DELIVERY</h4>
				    ...
				    ?>
				<form name="category_add" method="post" action="./mobile-delivery-instant-reject.php" onsubmit="return validate()">
				...
				?>
					...
					<table class="table w-50">
						<tr>
							...
							<td class="txt_lable">Device name & Model No:</td>
						</tr>
						<tr>
							<td><input type="text" class="form-control" disabled="yes" name="customer_name" value="<?php echo $customer_name ?>" >&nbsp;&nbsp;</td>
							<td><input type="text" class="form-control" disabled="yes" name="mobile_name" value="<?php echo $mobile_name ?>" ></td>
						</tr>
						...
						<tr>
							<td><input type="text" class="form-control" disabled="yes" name="mobile_defect" value="<?php echo $mob_def_result['defect_name'].$defect_2.$defect_3?>" >&nbsp;&nbsp;</td>
							<td><input  type="text" class="form-control" disabled="yes" name="exp_delivery" value="<?php echo $exp_delivery ?>" ></td>
						</tr>
						...
						<tr>
							...
							<td><input  type="text" class="form-control" readonly=yes name="est_amount" value="<?php echo $est_amount ?>" ></td>
						...
						<tr>
							<td><input  type="text" class="form-control" id="actual_amount" onblur="cal_bal()" name="actual_amount" readonly=yes value="<?php echo $actual_amount ?>" onkeypress="return numbersonly2(event)"></td>
							<!--<td><input type="text"  id="adjustments" onblur="cal_bal()" name="adjustments" value="" >&nbsp;&nbsp;</td> -->
							<td><input type="text" class="form-control" readonly="yes" name="entry_id_cust" value="<?php echo $entry_id;?>" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input  type="text" class="form-control" id="bal_amt" name="bal_amt" disabled=yes value="<?php echo $balance_amt;?>" onkeypress="return numbersonly3(event)"></td>
							<td><input  type="text" class="form-control" id="inst_rej_reason" name="inst_rej_reason" value="<?php echo $inst_rej_reason;?>" ></td>
							
						</tr>
						<input type="hidden" name="rejected_in_db" value="<?php echo $rejected;?>">
                        
						<tr>
							<td class="txt_lable">Job Attended By <span style="color:red">&#10033;</span></td>
						...
						?>
							...
							<td><input type="number" class="form-control" name="spare_cost" value="<?php echo $sparecost;?>" onkeypress="return isNumberKey(event)" onpaste="return false;" ondrop="return false;" autocomplete="off" ></td>
