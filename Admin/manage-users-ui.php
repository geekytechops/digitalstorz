        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="row">
				    ...
				    ?>
				    <form name="create_user" method="post" action="./manage-users-ui.php" onsubmit="return validate()">
					<table style="margin-left:30px" class="manage_users_table">
					    <input type="hidden" class="form-control" name="user_id_for_update" value="<?php echo $user_id_upd;?>">
					 <?php
					        if($_REQUEST['mode']!='edit'){
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Enter User ID (Mobile Number)&nbsp;&nbsp;</td> <td><input type="number"  required name="store_user_name" id="store_user_name" class="form-control" value="<?php echo $result_get_details['username'];?>" maxlength=10 onkeypress="if(this.value.length==10) return false;"  onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" /></td><td style="color:red; font-size:17px;padding-left:15px;">&#x2731;</td></tr>
					     <?php
					        }
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Name&nbsp;&nbsp;</td> <td><input type="text" name="staff_name" required class="form-control" value="<?php echo $result_get_details['staff_name'];?>"></td><td style="color:red; font-size:17px;padding-left:15px;">&#x2731;</td></tr>
                        <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Salary&nbsp;&nbsp;</td> <td><input type="text" name="staff_salary" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '₹ ', 'placeholder': '0'" class="form-control input-mask text-start" name="staff_salary" value=""></tr>
					    <tr>
                            <td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Timings&nbsp;&nbsp;</td>
                             <td>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="time" class="form-control" id="endTime" name="endTime">
					    ...
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Enter password&nbsp;&nbsp;</td> <td><input type="password" name="store_passwd" class="form-control"  required id="store_passwd"value=""></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td><td><input type="checkbox" onclick="ShowPassword()" class="form-check-input">Show Password</td></tr>
					    <?php
					        if($_REQUEST['mode']!='edit'){
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Re-Enter Password&nbsp;&nbsp;</td> <td><input type="password" required name="store_reenter_passwd" class="form-control" id="store_reenter_passwd" value="" ></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td><td><input type="checkbox" onclick="ShowPassword2()" class="form-check-input">Show Password</td></tr>
			            <?php
					        }
					    ?>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Date of Birth&nbsp;&nbsp;</td> <td><input type="date" name="staff_dob" class="form-control"  value="<?php echo $result_get_details['staff_dob'];?>"></td></tr>
					    ...
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Email Address&nbsp;&nbsp;</td> <td><input type="email" name="staff_email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" value="<?php echo $result_get_details['staff_email'];?>"></td><td style="color:red; font-size:15px;padding-left:15px;">&#x2731;</td></tr>
					    <tr><td class="txt_lable" style="text-align:right; font-family: 'Trebuchet MS', sans-serif;">Staff Residence Address&nbsp;&nbsp;</td> <td><input type="text" name="staff_residence" class="form-control" value="<?php echo $result_get_details['staff_residence'];?>"></td></tr>
					    <tr><td>&nbsp;</td></td></tr>
					    <tr><td>&nbsp;</td></td><td><input class="btn btn-primary" type="submit" name="<?php echo $btn_name?>" value="<?php echo $btn_value?>"></td></tr>
					</table>
					</form>
                    <?php
                ...
                <div class="row">
                    <div class="col-xl-12 col-sm-6">
                            <div class="card">
                                ...
                                <table class="order_hisory_table table table-bordered table-responsive">
											...
											?>
													<tr>
                                                            ...
                                                            <td><a class="btn btn-outline-info btn-sm" href="./manage-users-ui.php?mode=edit&user_id=<?php echo $result_com['user_id']?>">Edit</a></td>
														<?php
														...
														?>
															...
															?>
															<td><a class="btn btn-outline-danger btn-sm" href="./manage-users-ui.php?mode=disable&user_id=<?php echo $result_com['user_id']?>">Disable</a></td>
														<?php
                                                            
														  }else{ ?>

                                                                <td><a class="btn btn-outline-success btn-sm" href="./manage-users-ui.php?mode=enable&user_id=<?php echo $result_com['user_id']?>">Enable</a></td>
                                                            <?php
                                                          }
                                                        }
														...
														?>
															...
															?>
                                                            <td>
                                                                <select name="staff_role" class="form-select" id="staff_role" onchange="changeRole(this,<?php echo $result_com['user_id']?>)">
                                                                    <option value="0" <?php echo $result_com['staff_role']=='0' ? 'selected' : ''?>>Staff</option>
                                                                    <option value="1" <?php echo $result_com['staff_role']=='1' ? 'selected' : ''?>>Manager</option>
                                                                </select>
                                                            </td>
														<?php
															}
...
$(document).ready(function(){$(".input-mask").inputmask()});
        ...
        const changeRole = (element,userId) =>{
            let staffRole = $(element).val();
            $.ajax({
                type:'post',
                url:'manage-update.php',
                data:{staffRole:staffRole,userId:userId,formName:'updateStaff'},
