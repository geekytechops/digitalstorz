...
<div class="admin_menu_holder">
	...
	<div class="admin_menu_link"><a href="./view-gst-transactions.php">GST Reports&nbsp;&nbsp;|</a></div>
	<?php
	}
	?>
	<div class="admin_menu_link"><a href="./generate-invoice.php">Invoice&nbsp;&nbsp;|</a></div>
	<div class="admin_menu_link"><a href="./logout.php">Logout</a></div>
	<?php
	}if($_SESSION['session_user_role']=='superadmin'){
	?>
	<div class="admin_menu_link"><a href="superadmin-home.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-home'></i></i>Home&nbsp;&nbsp;|</a></div>
	...
	<div class="admin_menu_link"><a href="./activate-plans.php">Activate Plans&nbsp;&nbsp;|</a></div>
	<div class="admin_menu_link"><a href="./approve-kyc.php">Approve KYC&nbsp;&nbsp;|</a></div>
	<?php
	}
	?>
  ...
  <a href="user-plan-details.php">Plan Details</a>
  <?php
	if($_SESSION['session_user_role']=='admin'){
	?>
  ...
  <?php
	...
	if($_SESSION['session_user_role']=='superadmin'){
	    echo '<a href="manage-users.php">Manage Users</a>';
	    echo '<a href="manage-store-by-superadmin.php">Manage Stores</a>';
	    echo '<a href="sms-count.php">SMS Count</a>';
	}
	?>
